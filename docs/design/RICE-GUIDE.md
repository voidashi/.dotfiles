...
yellow means *warning* — mapping them to the alert family makes program output
...
At rest — no notifications, nothing urgent — **no more than two accent families should be
